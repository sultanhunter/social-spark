...
export function GptSlideAgentView({ collectionId }: { collectionId: string }) {
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "Failed to run GPT slide agent flow.");
      setStatusMessage("");
    } finally {
  ...
  return (
    <div className="flex-1 overflow-y-auto px-6 py-6 md:px-8">
      <div className="mx-auto w-full max-w-6xl space-y-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">GPT Slide Agent</CardTitle>
            <CardDescription>
